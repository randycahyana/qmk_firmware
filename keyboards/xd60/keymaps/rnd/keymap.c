...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [DVORAK] = LAYOUT_all(
      ...
      KC_LSPO            , KC_NO   , KC_SCLN , KC_Q    , KC_J    , KC_K    , KC_X    , KC_B      , KC_M    , KC_W    , KC_V    , KC_Z    , MO(FN)  , KC_UP   , MO(FN)  , \
  ...
  [QWERTY] = LAYOUT_all(
      ...
      KC_LSPO            , KC_NO   , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_N      , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , MO(FN)  , KC_UP   , MO(FN)  , \
      KC_LCTRL           , KC_LGUI , KC_LALT ,								 KC_SPC									 , KC_RALT , KC_RCTL , KC_LEFT , KC_DOWN , KC_RIGHT
      ),
  ...
  [FN] = LAYOUT_all(
      ...
      KC_PSCREEN         , RGB_TOG , RGB_VAD , KC_MUTE , KC_VOLU , KC_VOLD , KC_HOME , KC_PGDOWN , KC_PGUP , KC_END  , KC_TRNS , KC_TRNS , KC_NO   , KC_ENT  ,			 \
      KC_TRNS            , KC_NO   , KC_TRNS , KC_TRNS , KC_CIRC , KC_AMPR , KC_TRNS , KC_TRNS   , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_UP	 , KC_TRNS , \
      KC_LCTRL           , KC_LGUI , KC_TRNS ,								 KC_SPC									 , KC_TRNS , KC_TRNS , KC_LEFT , KC_DOWN , KC_RIGHT
      ),
};
